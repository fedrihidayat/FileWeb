...
function loadtoc(a) {
	...
	tocLoaded=true;
	displayToc2();
	document.write('</br><a href="http://bank-tugas.blogspot.co.id" style="font-size:10px;text-decoration:none;color:#616469;">Sitemap</a>')
}
